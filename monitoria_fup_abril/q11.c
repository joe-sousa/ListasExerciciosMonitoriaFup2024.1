...
int main(){
    ...
    printf("\nFace 1 %d vezes, com %.f %% de percentual ", face1, ((float)face1 * 100) / 100);
    printf("\nFace 2 %d vezes, com %.f %% de percentual ", face2, ((float)face2 * 100) / 100);
    printf("\nFace 3 %d vezes, com %.f %% de percentual ", face3, ((float)face3 * 100) / 100);
    printf("\nFace 4 %d vezes, com %.f %% de percentual ", face4, ((float)face4 * 100) / 100);
    printf("\nFace 5 %d vezes, com %.f %% de percentual ", face5, ((float)face5 * 100) / 100);
    printf("\nFace 6 %d vezes, com %.f %% de percentual ", face6, ((float)face6 * 100) / 100);
    return 0;
}